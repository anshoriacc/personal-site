...
export const Header = () => {
  ...
  return (
    <motion.header
      ...
      className={cn(
        "fixed left-1/2 top-4 z-404 flex h-10 -translate-x-1/2 items-center justify-between gap-4 rounded-full px-2 text-neutral-50 shadow-md border border-white/10 backdrop-blur-xl bg-background/5",
      )}>
